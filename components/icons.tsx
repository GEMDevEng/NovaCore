...
export const OnGoingIcon = (props: React.SVGProps<SVGSVGElement>) => (
     <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
...
export const SparklesIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-nova-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M5 3v4M3 5h4M6.226 14.226c-1.222-1.222-1.748-2.903-1.436-4.452 1.25 1.25 3.003 1.63 4.452 1.436-1.222 1.222-1.748 2.903-1.436 4.452-1.25-1.25-3.003-1.63-4.452-1.436zM17.774 9.774c-1.222-1.222-1.748-2.903-1.436-4.452 1.25 1.25 3.003 1.63 4.452 1.436-1.222 1.222-1.748 2.903-1.436 4.452-1.25-1.25-3.003-1.63-4.452-1.436zM21 19v-4M19 21h-4" />
    </svg>
);

export const CurrencyDollarIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v12m-3-2.818l.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 12.219 12.768 12 12 12c-.725 0-1.45-.22-2.003-.659-1.106-.879-1.106-2.303 0-3.182.553-.44 1.278-.659 2.003-.659.725 0 1.45.22 2.003.659l.879.659m0 0c-.452.339-1.005.525-1.557.525-.552 0-1.105-.186-1.557-.525m3.114 0l-3.114-2.335m3.114 2.335l-3.114 2.335" />
    </svg>
);
